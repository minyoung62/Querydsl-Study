...
public class QuerydslBasicTest {
    ...
    // 위에처럼 where에서 and로 chain으로 사용할 수있꼬 아래처럼 ,로 구분가능
    @Test
...
//                .containsExactly(20, 30, 40);
    ...
    @Test // tuple은 리파지토리 안에서만 쓴게 좋음 dto로 반환해서 밖으로 던져줘야함
    ...
    @Test
    public void findDtoBySetter() { //세터를 이용
    ...
    @Test
    public void findDtoByField() {//필드에 바로 넣음
        List<MemberDto> result = queryFactory
    ...
    @Test
    public void findDtoByConstructor() {//필드에 바로 넣음
        List<MemberDto> result = queryFactory
    ...
    @Test
    public void findUserDto() {//필드에 바로 넣음
